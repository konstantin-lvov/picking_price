...
public class Edit_row {
	...
	public void editRowWindow(ObservableList<Stuff> ob, Stage st, TableView table, int ri) {
		rowInd = ri;
	...
	public void showSecondWindow(ObservableList<Stuff> ob, int ri) {
		...
		tfName.setText(ob.get(rowInd).getName());
		tfPrice.setText(String.valueOf(ob.get(rowInd).getPrice()));
		cbDivide.setSelected(ob.get(rowInd).isCanDivide());
